    ...
    const handleButtonClick = (value) => {
        ...
        switch (value) {
            ...
            case 'Memory Addition':
                ...
                if (input || result) {
                    const valueToAdd = parseFloat(input) || parseFloat(result);
                   
                    const newMemoryValue = (memory ? parseFloat(memory) : 0) + valueToAdd;
                    setMemory(newMemoryValue);
                }
                
                console.log('Memory Addition to be added',memory);
                break;
            case 'Memory Subtract':
                ...
                if (input || result) {
                    ...
                    const newMemoryValue = (memory ? parseFloat(memory)- valueToAdd : valueToAdd) ;
                    setMemory(newMemoryValue);
                }
